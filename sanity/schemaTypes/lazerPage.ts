...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      initialValue: [
        { value: '+20 anos de experiência no mercado', description: '' },
        { value: '24/7 suporte operacional', description: '' },
        { value: '100% gestão personalizada', description: '' },
        { value: '+1000 operações executadas com sucesso', description: '' }
      ]
    }),

    // Bloco 3 - Argumentos de Venda
    defineField({
      name: 'arguments',
      title: 'Bloco 3 - Argumentos de Venda',
      type: 'object',
      fields: [
        defineField({
          name: 'title',
    ...
    // Bloco 4 - Sobre Experiências
    defineField({
      name: 'experiences',
      title: 'Bloco 4 - Sobre Experiências',
      type: 'object',
      fields: [
        defineField({
          name: 'title',
