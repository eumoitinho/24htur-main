// Script simples para criar documentos no Sanity
...
async function createSobrePage() {
  try {
    console.log('📄 Criando sobrePage com conteúdo exato...');
