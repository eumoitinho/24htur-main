...
import { EventPageProvider } from '../../../components/cbenf/EventPageContext';
import { getDocuments } from '../../../utils/lib/sanity';

export default async function EventoPage({ params }) {
  const eventData = await getDocuments('eventPage', params.slug);
  ...
  return (
    <EventPageProvider data={eventData}>
