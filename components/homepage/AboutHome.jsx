          ...
          >
            <div className="inline-flex items-center gap-2 mb-4">
              <span className="text-[14px] font-semibold uppercase tracking-[0.09em] text-brand-dark">
                {portableTextToPlain(aboutData?.badge) || 'SOBRE A 24H'}
              </span>
            </div>

            <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-slate-900 mb-6">
              {portableTextToPlain(aboutData?.title) || 'Mais de duas décadas especializados em gestão de viagens'}
            </h2>
            ...
            >
              {portableTextToPlain(aboutData?.ctaText) || 'FALE COM UM ESPECIALISTA!'}
