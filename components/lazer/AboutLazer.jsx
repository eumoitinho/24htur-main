...
const AboutLazer = () => {
  ...
  const about = lazerData?.aboutCompany || defaultAbout;
  const title = portableTextToPlain(about.title) || about.title;
  const subtitle = portableTextToPlain(about.subtitle) || about.subtitle;
  const description = portableTextToPlain(about.description) || about.description;
  const ctaText = about.ctaText || defaultAbout.ctaText;
